...
// Firestore path helpers - returns array of path segments for Firestore API
export const getCommandsCollectionPath = (deviceId: string): string[] => {
  return [FIRESTORE_COLLECTION_DEVICES, deviceId, FIRESTORE_COLLECTION_COMMANDS];
};

export const getCommandDocumentPath = (deviceId: string, commandId: string): string[] => {
  return [FIRESTORE_COLLECTION_DEVICES, deviceId, FIRESTORE_COLLECTION_COMMANDS, commandId];
};

export const getDeviceDocumentPath = (deviceId: string): string[] => {
